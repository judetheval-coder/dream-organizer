...
export const metadata = {
  title: 'Terms of Service - Dream Organizer',
  description: 'Terms of service for Dream Organizer - AI-powered dream journaling platform',
}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none space-y-6" style={{ color: colors.textSecondary }}>
          ...
          <section className="space-y-4">
            ...
            <p>
              By accessing or using Dream Organizer (&quot;the Service&quot;), you agree to be bound by these 
          ...
          <section className="space-y-4">
            ...
            <p>
              Dream Organizer is an AI-powered dream journaling platform that allows users to:
            </p>
          ...
          <section className="space-y-4">
            ...
            <p>
              The Service, including its design, code, and branding, is owned by Dream Organizer 
          ...
          <section className="space-y-4">
            ...
            <p>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, DREAM ORGANIZER SHALL NOT BE LIABLE FOR 
